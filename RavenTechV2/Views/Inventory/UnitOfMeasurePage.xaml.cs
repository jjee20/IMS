...
public sealed partial class UnitOfMeasurePage : Page
{

    public UnitOfMeasureViewModel ViewModel
    {
        get;
    }
    ...
    {
        ViewModel = App.GetService<UnitOfMeasureViewModel>();
        InitializeComponent();
    ...
    {
        if (sender is Button btn && btn.Tag is UnitOfMeasureVM item)
