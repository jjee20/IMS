...
namespace PresentationLayer.Presenters
{
    public class GoodsReceivedNotePresenter
    {
        ...
        private void Save(object? sender, EventArgs e)
        {
            ...
            if (Entity != null)
            {
                _view.Message = "GoodsReceivedNote type is already added.";
                return;
            }
            ...
            try
            {
                ...
                if (_view.IsEdit)//Edit model
                {
                    ...
                    _unitOfWork.Save();
                    _view.Message = "GoodsReceivedNote type edited successfuly";
                }
                else //Add new model
                {
                    _unitOfWork.GoodsReceivedNote.Add(model);
                    _unitOfWork.Save();
                    _view.Message = "GoodsReceivedNote type added sucessfully";
                }
        ...
        private void Delete(object? sender, EventArgs e)
        {
            try
            {
                ...
                _unitOfWork.Save();
                _view.IsSuccessful = true;
                _view.Message = "GoodsReceivedNote type deleted successfully";
                LoadAllGoodsReceivedNoteList();
            }
            catch (Exception)
            {
                _view.IsSuccessful = false;
                _view.Message = "An error ocurred, could not delete GoodsReceivedNote type";
            }
        }
