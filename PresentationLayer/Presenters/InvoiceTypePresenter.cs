...
namespace PresentationLayer.Presenters
{
    public class InvoiceTypePresenter
    {
        ...
        private void Save(object? sender, EventArgs e)
        {
            ...
            if (Entity != null)
            {
                _view.Message = "Invoice type is already added.";
                return;
            }
            ...
            try
            {
                ...
                if (_view.IsEdit)//Edit model
                {
                    ...
                    _unitOfWork.Save();
                    _view.Message = "Invoice type edited successfuly";
                }
                else //Add new model
                {
                    _unitOfWork.InvoiceType.Add(model);
                    _unitOfWork.Save();
                    _view.Message = "Invoice type added sucessfully";
                }
        ...
        private void Delete(object? sender, EventArgs e)
        {
            try
            {
                ...
                _unitOfWork.Save();
                _view.IsSuccessful = true;
                _view.Message = "Invoice type deleted successfully";
                LoadAllInvoiceTypeList();
            }
            catch (Exception)
            {
                _view.IsSuccessful = false;
                _view.Message = "An error ocurred, could not delete Invoice type";
            }
        }
