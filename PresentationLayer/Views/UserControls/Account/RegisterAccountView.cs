...
{
    public partial class RegisterAccountView : SfForm, IRegisterAccountView
    {
        ...
        public void SetRegisterAccountListBindingSource(IEnumerable<AccountViewModel> RegisterAccountList)
        {
            dgPager.DataSource = RegisterAccountList;

            foreach (var entity in RegisterAccountList)
            {
