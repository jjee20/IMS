...
{
    public partial class ExamFormatView : SfForm, IExamFormatView
    {
        public ExamFormatView()
        {
            InitializeComponent();
        }
        ...
        public void SetExamFormatListBindingSource(IEnumerable<ExamFormatViewModel> ExamFormatList)
        {
            dgPager.DataSource = ExamFormatList;

            foreach (var entity in ExamFormatList)
            {
