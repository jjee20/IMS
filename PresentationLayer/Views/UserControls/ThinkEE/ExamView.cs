...
{
    public partial class ExamView : SfForm, IExamView
    {
        public ExamView()
        {
            InitializeComponent();
        ...
        public void SetExamListBindingSource(IEnumerable<ExamViewModel> ExamList)
        {
            dgPager.DataSource = ExamList;

            foreach (var entity in ExamList)
            {
