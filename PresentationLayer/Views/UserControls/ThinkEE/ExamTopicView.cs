...
{
    public partial class ExamTopicView : SfForm, IExamTopicView
    {
        public ExamTopicView()
        {
            InitializeComponent();
        }
        ...
        public void SetExamTopicListBindingSource(IEnumerable<ExamTopicViewModel> ExamTopicList)
        {
            dgPager.DataSource = ExamTopicList;

            foreach (var entity in ExamTopicList)
            {
