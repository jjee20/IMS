...
{
    public partial class ReviewTopicView : SfForm, IReviewTopicView
    {
        public ReviewTopicView()
        {
            InitializeComponent();
        }
        ...
        public void SetReviewTopicListBindingSource(IEnumerable<ReviewTopicViewModel> ReviewTopicList)
        {
            dgPager.DataSource = ReviewTopicList;

            foreach (var entity in ReviewTopicList)
            {
