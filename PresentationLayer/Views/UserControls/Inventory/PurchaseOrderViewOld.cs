...
{
    public partial class PurchaseOrderViewOld : SfForm, IPurchaseOrderViewOld
    {
        ...
        private static PurchaseOrderViewOld? instance;
        public static PurchaseOrderViewOld GetInstance(TabPage parentContainer)
        {
            if (instance == null || instance.IsDisposed)
            {
                instance = new PurchaseOrderViewOld();
