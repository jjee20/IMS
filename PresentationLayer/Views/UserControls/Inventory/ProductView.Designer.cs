...
namespace PresentationLayer.Views.UserControls
{
    partial class ProductView
    {
        ...
        private void InitializeComponent()
        {
            ...
            gridTextColumn14.MappingName = "ProductId";
            ...
            gridTextColumn15.MappingName = "ProductName";
            ...
            gridTextColumn16.HeaderText = "Description";
            gridTextColumn16.MappingName = "Description";
            gridTextColumn17.AllowFiltering = true;
            gridTextColumn17.HeaderText = "Product Code";
            gridTextColumn17.MappingName = "ProductCode";
            gridTextColumn18.AllowFiltering = true;
            gridTextColumn18.HeaderText = "Barcode";
            gridTextColumn18.MappingName = "Barcode";
            gridTextColumn19.AllowFiltering = true;
            gridTextColumn19.HeaderText = "Brand";
            gridTextColumn19.MappingName = "Brand";
            gridTextColumn20.AllowFiltering = true;
            gridTextColumn20.HeaderText = "Color";
            gridTextColumn20.MappingName = "Color";
            gridTextColumn21.AllowFiltering = true;
            gridTextColumn21.HeaderText = "Size";
            gridTextColumn21.MappingName = "Size";
            gridTextColumn22.AllowFiltering = true;
            gridTextColumn22.HeaderText = "Description";
            gridTextColumn22.MappingName = "Description";
            gridTextColumn23.AllowFiltering = true;
            gridTextColumn23.HeaderText = "UOM";
            gridTextColumn23.MappingName = "UnitOfMeasure";
            gridTextColumn24.AllowFiltering = true;
            gridTextColumn24.HeaderText = "Buying Price";
            gridTextColumn24.MappingName = "DefaultBuyingPrice";
            gridTextColumn25.AllowFiltering = true;
            gridTextColumn25.HeaderText = "Selling Price";
            gridTextColumn25.MappingName = "DefaultSellingPrice";
            gridTextColumn26.AllowFiltering = true;
            gridTextColumn26.HeaderText = "Branch";
            gridTextColumn26.MappingName = "Branch";
