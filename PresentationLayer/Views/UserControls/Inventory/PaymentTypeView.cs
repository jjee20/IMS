...
namespace PresentationLayer.Views.UserControls
{
    public partial class PaymentTypeView : UserControl, IPaymentTypeView
    {
        ...
        private void AssociateAndRaiseViewEvents()
        {
            ...
            {
                var result = MessageBox.Show("Are you sure you want to delete the selected payment type?", "Warning",
        ...
        {
            dgList.DataSource = PaymentTypeList;
            DataGridHelper.ApplyDisplayNames<PaymentType>(PaymentTypeList, dgList);
        }
        ...
        private static PaymentTypeView? instance;
        public static PaymentTypeView GetInstance(TabPage parentContainer)
        {
            if (instance == null || instance.IsDisposed)
            {
                instance = new PaymentTypeView();
