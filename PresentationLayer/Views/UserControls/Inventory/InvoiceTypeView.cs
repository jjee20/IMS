...
namespace PresentationLayer.Views.UserControls
{
    public partial class InvoiceTypeView : UserControl, IInvoiceTypeView
    {
        ...
        private void AssociateAndRaiseViewEvents()
        {
            ...
            {
                var result = MessageBox.Show("Are you sure you want to delete the selected invoice type?", "Warning",
        ...
        private static InvoiceTypeView? instance;
        public static InvoiceTypeView GetInstance(TabPage parentContainer)
        {
            if (instance == null || instance.IsDisposed)
            {
                instance = new InvoiceTypeView();
