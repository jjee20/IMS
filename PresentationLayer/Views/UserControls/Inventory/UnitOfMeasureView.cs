...
namespace PresentationLayer.Views.UserControls
{
    public partial class UnitOfMeasureView : UserControl, IUnitOfMeasureView
    {
        ...
        private void AssociateAndRaiseViewEvents()
        {
            ...
            {
                var result = MessageBox.Show("Are you sure you want to delete the selected unit of measure?", "Warning",
        ...
        {
            dgList.DataSource = UnitOfMeasureList;
            DataGridHelper.ApplyDisplayNames<UnitOfMeasure>(UnitOfMeasureList, dgList);
        }
        ...
        private static UnitOfMeasureView? instance;
        public static UnitOfMeasureView GetInstance(TabPage parentContainer)
        {
            if (instance == null || instance.IsDisposed)
            {
                instance = new UnitOfMeasureView();
