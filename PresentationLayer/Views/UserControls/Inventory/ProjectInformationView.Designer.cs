namespace RavenTech_ERP.Views.UserControls.Inventory
{
    partial class ProjectInformationView
    {
        ...
        private void InitializeComponent()
        {
            ...
            gridNumericColumn6.HeaderText = "Actual";
            gridNumericColumn6.MappingName = "ActualAmount";
            gridNumericColumn6.ShowToolTip = true;
            gridNumericColumn7.AllowFiltering = true;
            gridNumericColumn7.Format = "N2";
            gridNumericColumn7.FormatMode = Syncfusion.WinForms.Input.Enums.FormatMode.Currency;
            gridNumericColumn7.HeaderText = "Remaining";
            gridNumericColumn7.MappingName = "RemainingAmount";
            gridNumericColumn7.ShowToolTip = true;
            gridNumericColumn8.AllowFiltering = true;
            gridNumericColumn8.Format = "N2";
            gridNumericColumn8.FormatMode = Syncfusion.WinForms.Input.Enums.FormatMode.Percent;
            gridNumericColumn8.HeaderText = "%";
            gridNumericColumn8.MappingName = "PercentageAmount";
