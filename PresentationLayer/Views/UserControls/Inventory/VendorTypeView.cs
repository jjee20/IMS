...
{
    public partial class VendorTypeView : SfForm, IVendorTypeView
    {
        ...
        public void SetVendorTypeListBindingSource(IEnumerable<VendorTypeViewModel> VendorTypeList)
        {
            dgPager.DataSource = VendorTypeList;

            foreach (var entity in VendorTypeList)
            {
