namespace PresentationLayer.Views.UserControls
{
    partial class VendorView
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtVendorType = new MaterialSkin.Controls.MaterialComboBox();
            ...
            // txtVendorType
            // 
            txtVendorType.AutoResize = false;
            txtVendorType.BackColor = Color.FromArgb(255, 255, 255);
            txtVendorType.Depth = 0;
            txtVendorType.DrawMode = DrawMode.OwnerDrawVariable;
            txtVendorType.DropDownHeight = 174;
            txtVendorType.DropDownStyle = ComboBoxStyle.DropDownList;
            txtVendorType.DropDownWidth = 121;
            txtVendorType.Font = new Font("Microsoft Sans Serif", 14F, FontStyle.Bold, GraphicsUnit.Pixel);
            txtVendorType.ForeColor = Color.FromArgb(222, 0, 0, 0);
            txtVendorType.FormattingEnabled = true;
            txtVendorType.Hint = "Select Vendor Type";
            txtVendorType.IntegralHeight = false;
            txtVendorType.ItemHeight = 43;
            txtVendorType.Location = new Point(653, 77);
            txtVendorType.Margin = new Padding(4, 5, 4, 5);
            txtVendorType.MaxDropDownItems = 4;
            txtVendorType.MouseState = MaterialSkin.MouseState.OUT;
            txtVendorType.Name = "txtVendorType";
            txtVendorType.Size = new Size(575, 49);
            txtVendorType.StartIndex = 0;
            txtVendorType.TabIndex = 14;
            // 
            // txtId
            // 
        ...
        private MaterialSkin.Controls.MaterialComboBox txtVendorType;
