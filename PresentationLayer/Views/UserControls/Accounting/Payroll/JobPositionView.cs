...
{
    public partial class JobPositionView : SfForm, IJobPositionView
    {
        ...
        public void SetJobPositionListBindingSource(IEnumerable<JobPositionViewModel> JobPositionList)
        {
            dgPager.DataSource = JobPositionList;

            foreach (var e in JobPositionList)
            {
