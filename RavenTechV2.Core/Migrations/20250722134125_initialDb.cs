    ...
    public partial class initialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkflowTransitions", x => x.WorkflowTransitionId);
                    table.ForeignKey(
                        name: "FK_WorkflowTransitions_AspNetUsers_PerformedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BankReconciliations", x => x.BankReconciliationId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaveCredits = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ShiftId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitOfMeasureId = table.Column<int>(type: "int", nullable: false),
                    DefaultBuyPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankReconciliationId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "BankReconciliationId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateDeducted = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProjectExpenseId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProjectId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectExpenses", x => x.ProjectExpenseId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllocationPercent = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchasePayments_Bills_BillId",
                        column: x => x.BillId,
            ...
            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Description", "Name", "NormalizedName", "UserId" },
                values: new object[,]
                {
                    { "2A538E36-48E9-4D95-B068-427B62104FFF", null, null, "Manager", "MANAGER", null },
                    { "F30E50F0-D08B-4A2F-90B5-EF67700894F7", null, null, "Admin", "ADMIN", null }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FullName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "81E9241B-309F-48AA-A9BF-980E8929834F", 0, "0b71175b-c0a3-4cfc-a27e-dd96cfeb8985", "admin@erp.com", true, "Administrator", false, null, "ADMIN@ERP.COM", "ADMIN", "AQAAAAIAAYagAAAAEGXU4wzwbrwi28DYHWZZAPFkazPvlx+80zp3lZJd5I7+pUPjKpa6WPNS5AxdMFKWHw==", null, false, "1c3b3e1a-5201-49cd-93a8-61a93dbb62b5", false, "admin" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "F30E50F0-D08B-4A2F-90B5-EF67700894F7", "81E9241B-309F-48AA-A9BF-980E8929834F" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LedgerEntries_ChartOfAccountId",
                table: "LedgerEntries",
                column: "ChartOfAccountId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchasePayments_BillId",
